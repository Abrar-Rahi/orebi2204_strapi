...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    color: Attribute.Component<'color.product-color', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiYearAddYearAdd extends Schema.CollectionType {
  collectionName: 'year_adds';
  info: {
    singularName: 'year-add';
    pluralName: 'year-adds';
    displayName: 'year_add';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::year-add.year-add': ApiYearAddYearAdd;
    }
  }
}
